...
RUN node -e "var p=require('./package.json');p.pnpm={onlyBuiltDependencies:['esbuild','sharp','swup','unrs-resolver','workerd','sass-embedded']};require('fs').writeFileSync('package.json',JSON.stringify(p,null,2))" && \
